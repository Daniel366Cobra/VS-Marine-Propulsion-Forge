...
public class BallastTankModel extends CTModel {
    ...
    protected static final ModelProperty<BallastTankModel.CullData> CULL_PROPERTY = new ModelProperty<>();

    public static BallastTankModel standard(BakedModel originalModel) {
        return new BallastTankModel(originalModel, VSMarinePropulsionSpriteShifts.BALLAST_TANK,
                VSMarinePropulsionSpriteShifts.BALLAST_TANK_TOP,
    ...
    protected ModelData.Builder gatherModelData(ModelData.Builder builder, BlockAndTintGetter world, BlockPos pos, BlockState state,
        ...
        BallastTankModel.CullData cullData = new BallastTankModel.CullData();
