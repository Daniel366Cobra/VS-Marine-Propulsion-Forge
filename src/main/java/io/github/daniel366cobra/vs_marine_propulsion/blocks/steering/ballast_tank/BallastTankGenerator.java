...
public class BallastTankGenerator extends SpecialBlockStateGen {
    ...
    public BallastTankGenerator() {
        this("");
    }

    public BallastTankGenerator(String prefix) {
        this.prefix = prefix;
    }
    ...
    public <T extends Block> ModelFile getModel(DataGenContext<Block, T> ctx, RegistrateBlockstateProvider prov,
                                                BlockState state) {
        Boolean top = state.getValue(BallastTankBlock.TOP);
        Boolean bottom = state.getValue(BallastTankBlock.BOTTOM);
