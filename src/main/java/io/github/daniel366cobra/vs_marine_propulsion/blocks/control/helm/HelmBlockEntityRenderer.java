...
public class HelmBlockEntityRenderer extends SafeBlockEntityRenderer<HelmBlockEntity> {

    public HelmBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    protected void renderSafe(HelmBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
        ...
        // Optional: Render helm base (static part) if you have separate models
        /*
        SuperByteBuffer base = CachedBufferer.partial(VSMarinePropulsionPartialModels.HELM_BASE, helmState);
        transform(base, helmState)
                .light(light)
                .renderInto(ms, vb);
        */
    }
